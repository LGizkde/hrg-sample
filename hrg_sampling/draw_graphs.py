...
if __name__ == '__main__':
    ...
    #labels=[]
    #likelihoods=[]
    #likelihoods.append(array(likelihoods1))
    #likelihoods.append(array(likelihoods2))
    #labels.append('dev')
    #labels.append('test')
    #plot_comparison_likelihood(likelihoods, labels, 'bleu-score-top-down-nontype.eps', 'top-down nontype-based BLEU result')
    #draw_likehood_from_file(sys.argv[1], sys.argv[2])
    plot_likelihood(array(likelihoods1), output_file, 'iter-likelihood')
